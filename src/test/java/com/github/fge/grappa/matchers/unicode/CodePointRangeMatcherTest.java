...
public final class CodePointRangeMatcherTest
{
    ...
    public Iterator<Object[]> testData()
    {
        ...
        list.add(new Object[] { 100, 232, 110, true, 1 });
        list.add(new Object[] { 100, 232, 232, true, 1 });
        list.add(new Object[] { 100, 232, 97, false, 0 });
        list.add(new Object[] { 100, 232, 401, false, 0 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, -1, false, 0 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, 0x1f393, true, 2 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, 0x1f400, true, 2 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, PILE_OF_POO, true, 2 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, 0x1f390, false, 0 });
        list.add(new Object[] { 0x1f393, PILE_OF_POO, 0x1f690, false, 0 });
